    ...
    with open(source_dir+'/'+filename, 'w') as fh:
        ...
        for ETI_file in list_ETI_files:
            ...
            if tmp[0].lower() == 'tpetra':
                ...
                if node_type == 'cuda':
                    node_type_internal = 'Kokkos_Compat_KokkosDeviceWrapperNode_Kokkos_Cuda_Kokkos_CudaSpace'
                if node_type == 'cudaUVM':
                    node_type_internal = 'Kokkos_Compat_KokkosDeviceWrapperNode_Kokkos_Cuda_Kokkos_CudaUVMSpace'
