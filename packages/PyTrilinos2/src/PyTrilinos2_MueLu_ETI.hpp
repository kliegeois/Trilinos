...
namespace MueLu {
  ...
  BINDER_MUELU_CREATETPETRAPRECONDITIONER2_INSTANT_2(double, int, long long, KokkosClassic::DefaultNode::DefaultNodeType)
  BINDER_MUELU_CREATETPETRAPRECONDITIONER3_INSTANT_2(double, int, long long, KokkosClassic::DefaultNode::DefaultNodeType)
  BINDER_MUELU_CREATETPETRAPRECONDITIONER4_INSTANT_2(double, int, long long, KokkosClassic::DefaultNode::DefaultNodeType)
  BINDER_MUELU_CREATETPETRAPRECONDITIONER5_INSTANT_2(double, int, long long, KokkosClassic::DefaultNode::DefaultNodeType)
