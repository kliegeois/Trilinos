...
{
	{ // ROL::Elementwise::Fill file:ROL_UnaryFunctions.hpp line:61
		pybind11::class_<ROL::Elementwise::Fill<double>, Teuchos::RCP<ROL::Elementwise::Fill<double>>, PyCallBack_ROL_Elementwise_Fill_double_t, ROL::Elementwise::UnaryFunction<double>> cl(M("ROL::Elementwise"), "Fill_double_t", "");
	...
	{ // ROL::Elementwise::Shift file:ROL_UnaryFunctions.hpp line:73
		pybind11::class_<ROL::Elementwise::Shift<double>, Teuchos::RCP<ROL::Elementwise::Shift<double>>, PyCallBack_ROL_Elementwise_Shift_double_t, ROL::Elementwise::UnaryFunction<double>> cl(M("ROL::Elementwise"), "Shift_double_t", "");
		cl.def( pybind11::init<const double &>(), pybind11::arg("value") );
	...
	{ // ROL::Elementwise::AbsoluteValue file:ROL_UnaryFunctions.hpp line:95
		pybind11::class_<ROL::Elementwise::AbsoluteValue<double>, Teuchos::RCP<ROL::Elementwise::AbsoluteValue<double>>, PyCallBack_ROL_Elementwise_AbsoluteValue_double_t, ROL::Elementwise::UnaryFunction<double>> cl(M("ROL::Elementwise"), "AbsoluteValue_double_t", "");
	...
	{ // ROL::Elementwise::Sign file:ROL_UnaryFunctions.hpp line:104
		pybind11::class_<ROL::Elementwise::Sign<double>, Teuchos::RCP<ROL::Elementwise::Sign<double>>, PyCallBack_ROL_Elementwise_Sign_double_t, ROL::Elementwise::UnaryFunction<double>> cl(M("ROL::Elementwise"), "Sign_double_t", "");
	...
	{ // ROL::Elementwise::Power file:ROL_UnaryFunctions.hpp line:123
		pybind11::class_<ROL::Elementwise::Power<double>, Teuchos::RCP<ROL::Elementwise::Power<double>>, PyCallBack_ROL_Elementwise_Power_double_t, ROL::Elementwise::UnaryFunction<double>> cl(M("ROL::Elementwise"), "Power_double_t", "");
	...
	{ // ROL::Elementwise::SquareRoot file:ROL_UnaryFunctions.hpp line:137
		pybind11::class_<ROL::Elementwise::SquareRoot<double>, Teuchos::RCP<ROL::Elementwise::SquareRoot<double>>, PyCallBack_ROL_Elementwise_SquareRoot_double_t, ROL::Elementwise::UnaryFunction<double>> cl(M("ROL::Elementwise"), "SquareRoot_double_t", "");
	...
	{ // ROL::Elementwise::UniformlyRandom file:ROL_UnaryFunctions.hpp line:175
		pybind11::class_<ROL::Elementwise::UniformlyRandom<double>, Teuchos::RCP<ROL::Elementwise::UniformlyRandom<double>>, PyCallBack_ROL_Elementwise_UniformlyRandom_double_t, ROL::Elementwise::UnaryFunction<double>> cl(M("ROL::Elementwise"), "UniformlyRandom_double_t", "");
	...
	{ // ROL::Elementwise::Multiply file:ROL_BinaryFunctions.hpp line:54
		pybind11::class_<ROL::Elementwise::Multiply<double>, Teuchos::RCP<ROL::Elementwise::Multiply<double>>, PyCallBack_ROL_Elementwise_Multiply_double_t, ROL::Elementwise::BinaryFunction<double>> cl(M("ROL::Elementwise"), "Multiply_double_t", "");
	...
	{ // ROL::Elementwise::Divide file:ROL_BinaryFunctions.hpp line:74
		pybind11::class_<ROL::Elementwise::Divide<double>, Teuchos::RCP<ROL::Elementwise::Divide<double>>, PyCallBack_ROL_Elementwise_Divide_double_t, ROL::Elementwise::BinaryFunction<double>> cl(M("ROL::Elementwise"), "Divide_double_t", "");
	...
	{ // ROL::Elementwise::DivideAndInvert file:ROL_BinaryFunctions.hpp line:84
		pybind11::class_<ROL::Elementwise::DivideAndInvert<double>, Teuchos::RCP<ROL::Elementwise::DivideAndInvert<double>>, PyCallBack_ROL_Elementwise_DivideAndInvert_double_t, ROL::Elementwise::BinaryFunction<double>> cl(M("ROL::Elementwise"), "DivideAndInvert_double_t", "");
	...
	{ // ROL::Elementwise::Min file:ROL_BinaryFunctions.hpp line:120
		pybind11::class_<ROL::Elementwise::Min<double>, Teuchos::RCP<ROL::Elementwise::Min<double>>, PyCallBack_ROL_Elementwise_Min_double_t, ROL::Elementwise::BinaryFunction<double>> cl(M("ROL::Elementwise"), "Min_double_t", "");
	...
	{ // ROL::Elementwise::Max file:ROL_BinaryFunctions.hpp line:130
		pybind11::class_<ROL::Elementwise::Max<double>, Teuchos::RCP<ROL::Elementwise::Max<double>>, PyCallBack_ROL_Elementwise_Max_double_t, ROL::Elementwise::BinaryFunction<double>> cl(M("ROL::Elementwise"), "Max_double_t", "");
	...
	{ // ROL::Elementwise::ValueSet file:ROL_BinaryFunctions.hpp line:166
		pybind11::class_<ROL::Elementwise::ValueSet<double>, Teuchos::RCP<ROL::Elementwise::ValueSet<double>>, PyCallBack_ROL_Elementwise_ValueSet_double_t, ROL::Elementwise::BinaryFunction<double>> cl(M("ROL::Elementwise"), "ValueSet_double_t", "");
