...
// ROL::ScalarFunction file: line:56
...
{
	// ROL::getValidROLParameters() file: line:55
	...
	// ROL::getValidSOLParameters() file: line:290
...
;
	...
	// ROL::EDescentUToString(enum ROL::EDescentU) file: line:74
	...
	// ROL::isValidDescentU(enum ROL::EDescentU) file: line:94
	...
	// ROL::StringToEDescentU(std::string) file: line:124
	...
	// ROL::ELineSearchU file: line:144
...
;
	...
	// ROL::ELineSearchUToString(enum ROL::ELineSearchU) file: line:156
	...
	// ROL::isValidLineSearchU(enum ROL::ELineSearchU) file: line:178
	...
	// ROL::StringToELineSearchU(std::string) file: line:210
	...
	// ROL::ECurvatureConditionU file: line:227
...
;
	...
	// ROL::ECurvatureConditionUToString(enum ROL::ECurvatureConditionU) file: line:237
	...
	// ROL::isValidCurvatureConditionU(enum ROL::ECurvatureConditionU) file: line:257
	...
	// ROL::StringToECurvatureConditionU(std::string) file: line:287
