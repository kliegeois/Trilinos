...
{
	// ROL::TypeE::EAlgorithmE file: line:59
...
;
	...
	// ROL::TypeE::EAlgorithmEToString(enum ROL::TypeE::EAlgorithmE) file: line:67
	...
	// ROL::TypeE::isValidAlgorithmE(enum ROL::TypeE::EAlgorithmE) file: line:85
	...
	// ROL::TypeE::StringToEAlgorithmE(std::string) file: line:114
	...
	// ROL::TypeE::AlgorithmFactory(class Teuchos::ParameterList &) file: line:125
