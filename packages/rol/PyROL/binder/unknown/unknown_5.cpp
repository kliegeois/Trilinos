...
// ROL::SemismoothNewtonProjection file: line:55
...
// ROL::RiddersProjection file: line:54
...
// ROL::BrentsProjection file: line:54
...
;
	...
	// ROL::EKrylovToString(enum ROL::EKrylov) file: line:75
	...
	// ROL::isValidKrylov(enum ROL::EKrylov) file: line:94
	...
	// ROL::StringToEKrylov(std::string) file: line:121
	...
	// ROL::KrylovFactory(class Teuchos::ParameterList &) file: line:132
	...
	// ROL::EPolyProjAlgo file: line:65
...
;
	...
	// ROL::EPolyProjAlgoToString(enum ROL::EPolyProjAlgo) file: line:75
	...
	// ROL::isValidPolyProjAlgo(enum ROL::EPolyProjAlgo) file: line:95
	...
	// ROL::StringToEPolyProjAlgo(std::string) file: line:126
	...
	// ROL::PolyhedralProjectionFactory(const class ROL::Vector<double> &, const class ROL::Vector<double> &, const class Teuchos::RCP<class ROL::BoundConstraint<double> > &, const class Teuchos::RCP<class ROL::Constraint<double> > &, const class ROL::Vector<double> &, const class ROL::Vector<double> &, class Teuchos::ParameterList &) file: line:137
