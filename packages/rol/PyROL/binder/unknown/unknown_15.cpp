...
{
	// ROL::TypeU::EAlgorithmU file: line:62
...
;
	...
	// ROL::TypeU::EAlgorithmUToString(enum ROL::TypeU::EAlgorithmU) file: line:69
	...
	// ROL::TypeU::isValidAlgorithmU(enum ROL::TypeU::EAlgorithmU) file: line:86
	...
	// ROL::TypeU::StringToEAlgorithmU(std::string) file: line:114
	...
	// ROL::TypeU::AlgorithmFactory(class Teuchos::ParameterList &) file: line:125
