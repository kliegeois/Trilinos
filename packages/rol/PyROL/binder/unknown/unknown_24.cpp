...
// ROL::TypeB::TrustRegionSPGAlgorithm file: line:59
...
// ROL::TypeB::ColemanLiAlgorithm file: line:61
...
void bind_unknown_unknown_24(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	// ROL::TypeB::EAlgorithmB file: line:74
...
;
	...
	// ROL::TypeB::EAlgorithmBToString(enum ROL::TypeB::EAlgorithmB) file: line:84
	...
	// ROL::TypeB::isValidAlgorithmB(enum ROL::TypeB::EAlgorithmB) file: line:104
	...
	// ROL::TypeB::StringToEAlgorithmB(std::string) file: line:135
	...
	// ROL::TypeB::AlgorithmFactory(class Teuchos::ParameterList &) file: line:146
