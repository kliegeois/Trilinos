...
void bind_ROL_ScalarController(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // ROL::MoreauYosidaObjective file:ROL_MoreauYosidaObjective.hpp line:67
		pybind11::class_<ROL::MoreauYosidaObjective<double>, Teuchos::RCP<ROL::MoreauYosidaObjective<double>>, PyCallBack_ROL_MoreauYosidaObjective_double_t, ROL::Objective<double>> cl(M("ROL"), "MoreauYosidaObjective_double_t", "");
